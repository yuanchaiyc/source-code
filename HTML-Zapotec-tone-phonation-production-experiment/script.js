...
{"word":"ncha'","spanish":"es diferente","english":"be different","path":"image/3.jpg","transcription":"ntʂâʔ","tone":"F","vowel":"a","phonation":"C","trial":"test"},
{"word":"cha'","spanish":"casuela","english":"clay pan","path":"image/4.jpg","transcription":"tʂàʔ","tone":"L","vowel":"a","phonation":"C","trial":"test"},
{"word":"xha'","spanish":"mi ropa","english":"my clothes","path":"image/5.jpg","transcription":"ʐáʔ","tone":"H","vowel":"a","phonation":"C","trial":"test"},
{"word":"kwa","spanish":"masa","english":"corn flour dough","path":"image/6.jpg","transcription":"kwâ","tone":"F","vowel":"a","phonation":"M","trial":"test"},
{"word":"za'a","spanish":"elote","english":"corn still growing","path":"image/7.jpg","transcription":"zà̰","tone":"L","vowel":"a","phonation":"R","trial":"test"},
...
{"word":"yo'","spanish":"tierra","english":"dirt","path":"image/11.jpg","transcription":"jôʔ","tone":"F","vowel":"o","phonation":"C","trial":"test"},
...
{"word":"nhi","spanish":"aquí","english":"here","path":"image/18.jpg","transcription":"nǐ","tone":"R","vowel":"i","phonation":"M","trial":"test"},
...
{"word":"yo'o","spanish":"casa","english":"house","path":"image/22.jpg","transcription":"jô̰","tone":"F","vowel":"o","phonation":"R","trial":"test"},
...
{"word":"lba'a","spanish":"garganta","english":"neck","path":"image/28.jpg","transcription":"lbáʔa","tone":"L","vowel":"a","phonation":"R","trial":"test"},
...
{"word":"nha'","spanish":"allá","english":"there","path":"image/41.jpg","transcription":"nàʔ","tone":"L","vowel":"a","phonation":"C","trial":"test"},
{"word":"chi'i","spanish":"voz","english":"voice","path":"image/43.jpg","transcription":"tʂḭ̌","tone":"H","vowel":"i","phonation":"R","trial":"test"},
{"word":"nho","spanish":"quién","english":"who","path":"image/44.jpg","transcription":"nǒ","tone":"R","vowel":"o","phonation":"M","trial":"test"},
...
{"word":"bjo'","spanish":"luna","english":"moon","path":"image/51.jpg","transcription":"bjǒʔ","tone":"R","vowel":"o","phonation":"C","trial":"test"},
{"word":"bjo'o","spanish":"pulga de perro","english":"dog flea","path":"image/52.jpg","transcription":"bjòʔó","tone":"R","vowel":"o","phonation":"R","trial":"test"}]

/*
var word_list = [{"word":"bjo'","spanish":"luna","english":"moon","path":"image/51.jpg","transcription":"bjǒʔ","tone":"R","vowel":"o","phonation":"C","trial":"test"},
{"word":"bjo'o","spanish":"pulga de perro","english":"dog flea","path":"image/52.jpg","transcription":"bjòʔó","tone":"R","vowel":"o","phonation":"R","trial":"test"}]
*/
...
function Runs500msAfterFixation() {
    ...
    if (curTrial < part1Length) {
        ...
        $("#ProductionTrialNumDiv").text(trialnum + "/" + totalnum + " (" + curTrial + ")");
        $("#ProductionTrialDiv").show();
        display_text = "«" + trialListRandom[curTrial].word + "»" + " nachho " + "«" + trialListRandom[curTrial].spanish + "»" + " xtichhato.";
        display_text_spanish = "«" + trialListRandom[curTrial].word + "»" + " es la palabra para " + trialListRandom[curTrial].spanish + " en nuestro idioma";
        $("#ProductionTextSpanish").text(display_text_spanish);
        $("#ProductionText").text(display_text);
        $("#ProductionTrialImage").attr("src", trialListRandom[curTrial].path);
        $("#ProductionTrialButton").on("click", CheckProgress);
