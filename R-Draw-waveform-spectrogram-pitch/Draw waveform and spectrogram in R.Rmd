...
* The source code and the example files are [here](https://github.com/yuanchaiyc/source-code/tree/main/R-Draw-waveform-spectrogram-pitch).
* R code online are [here](https://posit.cloud/content/5036221).
